  ...
  return (
   <aside className='side-bar'>
       ...
       <ul className='sidebar-links'>
          <li> <NavLink className="nav-links" to='/dashboard/overview' exact style={({ isActive }) => ({ background: isActive ? "rgb(54, 77, 217)" : "none" , color: isActive? 'white':"#5C6578"})}><IoMdStats className='links-icon'/> Overview</NavLink></li>
          <li><NavLink className="nav-links" to='/dashboard/applications' exact style={({ isActive }) => ({ background: isActive ? "#364DD9" : "none" ,color: isActive? 'white':"#5C6578"})}><MdQueryStats className='links-icon'/>  Applications</NavLink></li>
