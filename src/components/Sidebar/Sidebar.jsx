  ...
  return (
   <aside className='side-bar'>
       ...
       <ul className='sidebar-links'>
          <li> <NavLink className="nav-links" to='/dashboard' style={({ isActive }) => ({ background: isActive ? "rgb(54, 77, 217)" : "none" , color: isActive? 'white':"#5C6578"})}><IoMdStats className='links-icon'/> Overview</NavLink></li>
